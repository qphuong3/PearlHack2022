...
public class AntarcticAnimals extends Application {
    ...
    public void start(Stage stage) {
        ...
        makeButton("Blue Whale", "blue-whale.mp3", "BLUE_WHALE.png", blue, 400, info);
        makePath(blue, 600.0f, -66.0f, -350.0f, -66.0f, 10);
        makeButton("Fin Whale", "fin-whales.mp3", "FIN_WHALE.png", fin, 240, info);
        makePath(fin, 600.0f, -30.0f, -350.0f, -30.0f, 16);
        makeButton("Orca", "Killer_Whales.mp3", "ORCA.png", orca, 128, info);
        makePath(orca, 600.0f, -66.0f, -350.0f, 50.0f, 3);
        makeButton("Sei Whale", "Sei_Whale.mp3", "SEI_WHALE.png", sei, 240, info);
        makePath(sei, 600.0f, 6.0f, -350.0f, 6.0f, 3);


        makeButton("Humpback Whale", "Humpback.mp3", "humpback.png", hump, 240, info);
        makePath(hump, -350.0f, -30.0f, 600.0f, -30.0f, 18);
        makeButton("Minke Whale", "Minke_Whale.mp3", "minke.png", minke, 160, info);
        makePath(minke, -350.0f, 10.0f, 600.0f, 10.0f, 8);
        makeButton("Sperm Whale", "Sperm_Whale.mp3", "sperm.png", sperm, 240, info);
        makePath(sperm, -350.0f, 200.0f, 600.0f, 200.0f, 22);
        makeButton("Southern Right Whale", "SRW.mp3", "Southern.png", south, 200, info);
